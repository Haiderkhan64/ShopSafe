        ...
        <div className="w-full h-full p-4 md:p-6 lg:p-8 flex flex-col">
          ...
          <div className="mt-6 flex justify-center">
            <div className="flex items-center gap-2">
              <div
                className="w-2 h-2 rounded-full bg-purple-500 dark:bg-purple-400 animate-pulse"
                style={{ animationDuration: "2s" }}
              />
              <div
                className="w-2 h-2 rounded-full bg-yellow-500 dark:bg-yellow-400 animate-pulse"
