  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-indigo-50/20 dark:from-slate-950 dark:via-purple-950/30 dark:to-indigo-950/20 overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Ambient particles in brand colors */}
        {[...Array(8)].map((_, i) => (
          <div
            key={i}
        ...
        <div className="relative flex flex-col items-center gap-8">
          ...
          <div className="relative">
            ...
            >
              ...
              {/* Center Shield Icon (from your logo) */}
              <div className="relative z-10">
                <div className="relative w-24 h-24 flex items-center justify-center">
                  ...
                  {/* Orbiting Dots - Brand Colors */}
                  {[
                    {
                      color: "from-[#574095] to-[#6B46C1]",
                      darkColor: "dark:from-[#6B46C1] dark:to-[#8B5CF6]",
                      delay: "0s",
                      duration: "3s",
                    },
                    {
                      color: "from-[#6B46C1] to-purple-500",
                      darkColor: "dark:from-[#8B5CF6] dark:to-purple-400",
                      delay: "0.3s",
                      duration: "3.5s",
                    },
                    {
                      color: "from-yellow-400 to-yellow-500",
                      darkColor: "dark:from-yellow-300 dark:to-yellow-400",
                      delay: "0.6s",
                      duration: "4s",
                    },
                    {
              ...
              {[
                {
                  ...
                  darkBg: "dark:from-purple-900/50 dark:to-purple-800/30",
                  text: "text-[#574095] dark:text-purple-300",
                  border: "border-white/50 dark:border-purple-500/30",
                },
                {
                  icon: "⚡",
                  label: "Fast",
                  bg: "from-yellow-100 to-yellow-50",
                  darkBg: "dark:from-yellow-900/50 dark:to-yellow-800/30",
                  text: "text-[#D97706] dark:text-yellow-300",
                  border: "border-white/50 dark:border-yellow-500/30",
                },
                {
                  icon: "✓",
                  label: "Trusted",
                  bg: "from-indigo-100 to-indigo-50",
                  darkBg: "dark:from-indigo-900/50 dark:to-indigo-800/30",
                  text: "text-[#6B46C1] dark:text-indigo-300",
                  border: "border-white/50 dark:border-indigo-500/30",
                },
              ].map((badge, index) => (
                <div
                  key={index}
